...
@WebServlet("/BoardingPointServlet")
public class BoardingPointServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        if (routeIdParam == null || routeIdParam.isBlank()
            ...
            res.sendRedirect(req.getContextPath() + "/Admin/Add_BoardingPoint.jsp");
            return;
        }

        String sql =
            "INSERT INTO boarding_points (route_id, location, boarding_time) VALUES (?, ?, ?)";
